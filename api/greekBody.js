        ...
        <div class="container"> 
            ...
            <div class="collapse navbar-collapse" id="xenav"> 
                <ul class="navbar-nav ml-auto"> 
                    <li class="nav-item"> 
                        <a class="nav-link mainMenuNew" href="#aboutus">Ποιοί Είμαστε</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link mainMenuNew" href="#our-team">Ο Στόλος</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link mainMenuNew" href="#our-feature">Υπηρεσίες</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link mainMenuNew" href="#portfolio-xe">Αποδράσεις</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link mainMenuNew" href="#ourhome">Κρατήσεις</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link mainMenuNew" href="#our-testimonial">Είπαν Για Εμάς</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link mainMenuNew" href="https://blog.breezerentals.gr/" target="_blank" >Blog</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link mainMenuNew" href="#contactus">Επικοινωνία</a> 
                    </li>         
    ...
    <div class="side-menu"> 
        <div class="inner-wrapper"> 
            ...
            <nav class="side-nav"> 
                <ul class="navbar-nav w-100"> 
                    <li class="nav-item active"> 
                        <a class="nav-link" href="#aboutus">Ποιοί Είμαστε</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link" href="#our-team">Ο Στόλος</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link" href="#our-feature">Υπηρεσίες</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link" href="#portfolio-xe">Αποδράσεις</a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link" href="#ourhome">Κρατήσεις                                  
                        </a> 
                    </li>                             
                    <li class="nav-item"> 
                        <a class="nav-link" href="#our-testimonial">Είπαν Για Εμάς</a> 
                    </li>                             
                    <li class="nav-item"> 
            ...
            <ul class="social-icons-simple white top50 w-100"> 
                ...
                <li>
                    <a href="javascript:void(0)"><i class="fa fa-yout"></i> </a> 
                </li>                         
            </ul>                     
            <p class="whitecolor">&copy; 2019 Breeze Car Rental Company. | </p> 
        </div>                 
    </div>             
            ...
            <div class="col-md-6 nopadding"> 
                <div class="split-box text-center center-block container-padding equalheight" id="btn-feature"> 
                    <div class="heading-title padding"> 
                        <span class=" wow fadeIn" data-wow-delay="300ms">Σχετικά Με Εμάς</span> 
                        <h2 class="darkcolor bottom20 wow fadeIn" data-wow-delay="350ms">Καλύτερες τιμές, Καλύτερα Αυτοκίνητα</h2> 
                        <p class="heading_space wow fadeIn" data-wow-delay="400ms"> 
                            H Breeze Car Rental είναι μια νέα εταιρία στον χώρο ενοικίασης αυτοκινήτων με έδρα την Αθήνα. 
                            Στον έναν χρόνο λειτουργίας μας έχουμε καταφέρει να προσφέρουμε υψηλού επιπέδου υπηρεσίες στους πελάτες μας με έναν ολοκαίνουργιο στόλο αυτοκινήτων σε πολύ ανταγωνιστικές τιμές. 
                            Η φιλοσοφία μας στηρίζεται στην προσωποποιημένη εξυπηρέτηση όλων των πελατών μας στους οποίους προσφέρουμε κάθε δυνατή εξυπηρέτηση για την βέλτιστη εμπειρία του.
...
<div class="row"> 
    <div class="col-md-6 nopadding"> 
        <div class="split-box text-center center-block container-padding equalheight"> 
            <div class="heading-title padding"> 
                <span class="wow fadeIn" data-wow-delay="300ms">Ανακαλύψτε Περισσότερα</span> 
                <h2 class="darkcolor bottom20 wow fadeIn" data-wow-delay="350ms">Εξαιρετική εμπειρία</h2> 
                <p class="heading_space wow fadeIn" data-wow-delay="400ms">  
                    Η breeze Car Rental προσπαθεί καθημερινά να βελτιώνει την εμπειρία του πελάτη προτείνοντας τις καλύτερες λύσεις και επιλογές.  
                    Είμαστε εδώ για εσάς είκοσι τέσσερις ώρες το εικοσιτετράωρο για να σας βοηθήσουμε σε ότι και αν χρειαστείτε.
</p> 
            </div>                     
        </div>                 
    </div>             
...
<div class="row"> 
    <div class="col-md-12 col-sm-12 text-center"> 
        <div class="heading-title wow fadeInUp" data-wow-delay="300ms"> 
            <h2 class="whitecolor">Γιατί να μας επιλέξτε <span class="fontregular"></span> </h2> 
        </div>                 
    </div>             
</div>         
<div class="row"> 
    <ul class="process-wrapp"> 
        <li class="whitecolor wow fadeIn" data-wow-delay="350ms"> 
            ...
            <p class="fontbold bottom25">Προσωποποιημένη εξυπηρέτηση</p> 
            <p>Γνωρίζουμε τους πελάτες μας προσωπικά είναι φίλοι μας όχι απλά πελάτες.</p> 
        </li>                 
        <li class="whitecolor wow fadeIn" data-wow-delay="400ms"> 
            <span class="pro-step bottom20">02</span> 
            <p class="fontbold bottom25">Πολλαπλές Τοποθεσίες</p> 
            <p>Μπορούμε να παραδώσουμε το αυτοκίνητό σας σε όποια τοποθεσία επιθυμείτε </p> 
        </li>                 
        <li class="whitecolor wow fadeIn" data-wow-delay="500ms"> 
            <span class="pro-step bottom20">03</span> 
            <p class="fontbold bottom25">24/7 Υποστήριξη</p> 
            <p>Μπορείτε να επικοινωνείτε μαζί μας διαρκώς και για όποιο πρόβλημα προκύψει </p> 
        </li>                 
        <li class="whitecolor wow fadeIn" data-wow-delay="600ms"> 
            <span class="pro-step bottom20">04</span> 
            <p class="fontbold bottom25">Καινούργιος Στόλος</p> 
            <p>Όλα τα αυτοκίνητα είναι καινούργια και καλοσυντηρημένα </p> 
        </li>                 
    </ul>             
</div>         
</div>     
...
<div class="row"> 
    <div class="col-md-8 offset-md-2 col-sm-12 text-center"> 
        <div class="heading-title wow fadeInUp" data-wow-delay="300ms"> 
            <span>Ποτέ δεν ξεχνιέται η μυρωδιά ενός καινούργιου αυτοκινήτου</span> 
            <h2 class="darkcolor bottom20">Ο Στόλος Μας</h2> 
            <p class="bottom10"> 
                Η Breeze Car Rental διαθέτει 15 ολοκαίνουργια αυτοκίνητα VW τα οποία έχουν αγοραστεί από το 2017 και μετά. 
                Η ασφάλεια σας είναι πολύ σημαντική για εμάς ειδικά εάν έχετε να μετακινηθείτε σε δύσκολους δρόμους και για πολλές μέρες. 
                Ανεξάρτητα από το πού η γιατί ταξιδεύετε μπορείτε να υπολογίζετε στον στόλο μας τα οποία προσφέρουν την μέγιστη άνεση και ασφάλεια.  
            </p> 
        </div>                 
    </div>             
</div>         
...
<div class="row"> 
    <div class="col-md-6 col-sm-7 text-md-left text-center wow fadeInLeft" data-wow-delay="300ms"> 
        <div class="heading-title heading_space"> 
            <span>Οι Υπηρεσίες που προσφέρουμε</span> 
            <h2 class="darkcolor bottom30">Εξαιρετικά Χαρακτηριστικά</h2> 
        </div>                 
        <p><strong style="color:#a5ce44"> Πολλαπλές Τοποθεσίες:</strong> Είναι η πτήση σας αργά το βράδυ? Μην ανησυχείτε το γραφείο μας προσφέρει υπηρεσίες παράδοσης όλο το εικοσιτετράωρο. .</p> 
        <p><strong style="color:#a5ce44">Βοήθεια σε περίπτωση ατυχήματος :</strong> Ελπίζουμε να μην σας χρειαστεί ποτέ αλλά ένα σας τύχει υπάρχει ένα νούμερο σε κάθε συμβόλαιό για να μας καλέσετε και να σας βοηθήσουμε να σας αντικαταστήσουμε το αυτοκίνητό σας για να συνεχίσετε χωρίς πρόβλημα την εκδρομή σας</p> 
        <p><strong style="color:#a5ce44">Αλυσίδες Χιονιού:</strong>Είναι γνωστό ότι δεν κάνει κρύο στην Ελλάδα μα υπάρχουν φορές που σε ορισμένες περιοχές ο καιρός χαλάει. Ιδιαίτερα μεταξύ Νοέμβρη και Φεβρουαρίου χιονίζει και σας συνιστούμε να ζητήσετε να σας προμηθεύσουμε με τον κατάλληλο εξοπλισμό.</p> 
    </div>             
...
<div class="row"> 
    <div class="col-md-8 offset-md-2 col-sm-12 text-center"> 
        <div class="heading-title wow fadeInUp" data-wow-delay="300ms"> 
            ...
            <h2 class="darkcolor bottom10">Αποδράσεις από την Αθήνα</h2> 
            <p class="heading_space"> 
                Εγγραφείτε στο Blog μας και στην σελίδα μας στο Facebook και στο Instagram και ενημερωθείτε για τις προτάσεις μας για αποδράσεις γύρω από την Αθήνα.  Ανακαλύψτε όλα τα κρυφά σημεία για φαγητό, σπορ και παραλίες που λίγοι τα ξέρουν και εμείς έχουμε ανακύψει για εσάς. 
...
<div class="container">
 <div class="row">
    <div class="col-md-5 col-sm-12 margin_bottom whitecolor text-md-left text-center wow fadeInLeft"
       ...
       <p class="title">We show you our professional achievements in numbers, which show the acquired skills
          and trust of many clients.</p>
    </div>
...
<div class="row"> 
    <div class="col-md-12 col-sm-12 text-center"> 
        <div class="heading-title bottom30 wow fadeInUp" data-wow-delay="300ms"> 
            ...
            <h2 class="darkcolor">Οι πελάτες Μας</h2> 
        </div>                 
    </div>             
</div>         
<div class="row"> 
...
<div class="row"> 
    <div class="col-md-12 col-sm-12"> 
        <div class="heading-title heading_space wow fadeInUp" data-wow-delay="300ms"> 
            ...
            <h2 class="darkcolor">Επικοινωνήστε με την Breeze Car Rentals</h2> 
        </div>                 
    </div>             
    <div class="col-md-6 col-sm-12 margin_bottom wow fadeInUp" data-wow-delay="350ms"> 
        <p>Κάντε μία προ κράτηση ή μια ακύρωση ή ότι άλλο χρειάζεστε και μπορούμε να σας βοηθήσουμε. Μπορείτε να μας στείλετε email ή να μας τηλεφωνήσετε όποια ώρα της ημέρας θέλετε στα στοιχεία επικοινωνίας παρακάτω. Όλο το προσωπικό μας θα χαρεί πολύ να σας εξυπηρετήσει και να ανταποκριθεί σε όλες σας τις απαιτήσεις.</p> 
        <div class="row"> 
            <div class="col-md-6 col-sm-6 our-address top40"> 
                <h5 class="bottom25">Το κεντρικό Γραφείο μας</h5> 
                <p class="bottom15">Αγίας Τριάδος 72, Αγία Παρασκευή Αθήνα</p> 
                <a class="pickus" href="https://goo.gl/maps/7tkPPJnEFX92" data-text="Οδηγίες" target="_blank">Οδηγίες</a> 
            </div>                     
            <div class="col-md-6 col-sm-6 our-address top40"> 
                <h5 class="bottom25">Το τηλέφωνό μας</h5> 
                <p class="bottom15">Σταθερό τηλέφωνο : (+30) 21 0608 0461 <span class="block"> 
                   Κινητό : (+30) 63165370895
</span> </p> 
                <a class="pickus" href="callto:+3063165370895" data-text="Καλέστε μας">Καλέστε μας</a> 
            </div>                     
            <div class="col-md-6 col-sm-6 our-address top40"> 
                <h5 class="bottom25">Το email του κεντρικού μας γραφείου</h5> 
                <p class="bottom25">Κεντρικό email: info@breezerentals.gr <span class="block">Κρατήσεις :
                   reservations@breezerentals.gr</span> </p> 
                <a class="pickus" href="mailto:info@breezerentals.gr" data-text="Στείλτε μας ένα μήνυμα">Στείλτε μας ένα μήνυμα</a> 
            </div>                     
            <div class="col-md-6 col-sm-6 our-address top40"> 
                <h5 class="bottom25">Γραφείο στο Νησί της Πάρου</h5> 
                <p class="">paros@breezerentals.gr</p>
                <p class="bottom15"><span class="block"></span>Κρατήσεις: reservations@breezerentals.gr</span></p> 
            ...
            <div class="row"> 
                ...
                <div class="col-md-6 col-sm-6"> 
                    <div class="form-group bottom35"> 
                        <input class="form-control" type="text" placeholder="Όνομα:" required id="first_name" name="first_name"> 
                    </div>                             
                </div>                         
                <div class="col-md-6 col-sm-6"> 
                    <div class="form-group bottom35"> 
                        <input class="form-control" type="text" placeholder="Επίθετο:" required id="last_name" name="last_name"> 
                    </div>                             
                </div>                         
                <div class="col-md-6 col-sm-6"> 
                    <div class="form-group bottom35"> 
                ...
                <div class="col-md-6 col-sm-6"> 
                    <div class="form-group bottom35"> 
                        <input class="form-control" type="tel" placeholder="Τηλεφωνο:" id="phone" name="phone"> 
                    </div>                             
                </div>                         
                <div class="col-md-12 col-sm-12"> 
                    <div class="form-group bottom35"> 
                        <textarea class="form-control" placeholder="Μήνυμα" id="message" name="message"></textarea>                                 
                    </div>                             
                </div>                         
                <div class="col-sm-12"> 
                    <button type="submit" class="button btnprimary" id="submit_btn">Απόστολή</button>                             
                </div>                         
            </div>                     
        </form>                 
    </div>             
...
<div class="row"> 
    <div class="col-md-12 col-sm-12 text-center"> 
        <ul class="social-icons bottom25 wow fadeInUp" data-wow-delay="300ms" style="visibility: hidden; animation-delay: 300ms; animation-name: none;"> 
            ...
            <li>
                <a href="javascript:void(0)"><i class="fas fa-at"></i> </a> 
            </li>                     
        </ul>                 
...
<div class="row">
        <div class="col-md-12 col-sm-12 text-center consentLinks"> 
            ...
            <a href="#" data-toggle="modal" data-target="#consent" data-text="Πολιτική Απορρήτου">Πολιτική Cookies</a>&nbsp;&nbsp;
            <a href="#" data-toggle="modal" data-target="#privacyPolicy" data-text="Πολιτική Απορρήτου">Πολιτική Προστασίας Προσωπικών Δεδομένων</a>&nbsp;&nbsp;
        </div>
</div>
</div>   
</footer> 
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-header" style="color:#000;">
      <h4>Πολιτική Απορρήτου - Breeze Rentals</h4>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-header text-center" style="color:#000;">
      <h4>Συνήθεις Ερωτήσεις Απαντήσεις - Breeze Rentals</h4>
      <button type="button" class="close" data-dismiss="modal">&times;</button>
    </div>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <!-- Modal Header -->
    <div class="modal-header" style="color:#000;">
      <h4>Όροι Χρήσης του διαδικτυακού τόπου - Breeze Rentals</h4>
      <button type="button" class="close" data-dismiss="modal">&times;</button>
    </div>
