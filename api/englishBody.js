                ...
                <div class="container"> 
                    ...
                    <div class="collapse navbar-collapse" id="xenav"> 
                        <ul class="navbar-nav ml-auto"> 
                            ...
                            <li class="nav-item"> 
                                <a class="nav-link mainMenuNew" href="#ourhome">Reservations</a> 
                            </li>                             
                            <li class="nav-item"> 
                ...
                <div class="inner-wrapper"> 
                    ...
                    <nav class="side-nav"> 
                        <ul class="navbar-nav w-100"> 
                            ...
                            <li class="nav-item"> 
                                <a class="nav-link" href="#ourhome">Reservations                                 
                                </a> 
                            </li>                             
                            <li class="nav-item"> 
                    ...
                    <ul class="social-icons-simple white top50 w-100"> 
                        <li>
                            <a href="https://www.facebook.com/Breeze-Car-rentals-278431269484379" target="_blank"><i class="fa fa-facebook"></i> </a> 
                        </li>                         
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-instagram"></i> </a> 
                        </li>                         
                        <li>
                            <a href="https://blog.breezerentals.gr/" target="_blank"><i class="fa fa-wordpress"></i> </a> 
                        </li>                         
                        <li>
...
<section id="our-testimonial" class="padding"> 
    <div class="container"> 
        ...
        <div class="row"> 
            ...
            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1520px, 0px, 0px); transition: all 0s ease 0s; width: 3800px;"><div class="owl-item cloned" style="width: 350px; margin-right: 30px;"><div class="item"> 
    ...
    <div class="col-md-6 col-sm-12 margin_bottom wow fadeInUp" data-wow-delay="350ms"> 
        ...
        <div class="row"> 
            ...
            <div class="col-md-6 col-sm-6 our-address top40"> 
                ...
                <p class="bottom15">Σταθερό τηλέφωνο : (+30) 210 600 0058 <span class="block"> 
            ...
            <div class="row"> 
                ...
                <div class="col-md-6 col-sm-6"> 
                    <div class="form-group bottom35"> 
                        <input class="form-control" type="text" placeholder="Name:" required id="first_name" name="first_name"> 
                    </div>                             
                </div>                         
                <div class="col-md-6 col-sm-6"> 
                    <div class="form-group bottom35"> 
                ...
                <div class="col-sm-12"> 
                    <button type="submit" class="button btnprimary" id="submit_btn">Send Now</button>                             
                </div>                         
            </div>                     
        </form>                 
    </div>             
